...
export default (client, repository, cache, master = false) => {
    ...
    const init = async () => {
        ...
        try {
            ...
            console.log(repositoryTransfermarkt)
        ...
        if(repositoryTransfermarkt) {
            console.log('transfermarkt from repository', repositoryTransfermarkt)
            transfermarkt = repositoryTransfermarkt
        } else {
            console.log('transfermarkt from file', repositoryTransfermarkt)
