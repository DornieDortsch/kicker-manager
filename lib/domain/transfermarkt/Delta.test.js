...
describe('Delta', () => {
    ...
    const htmlWithOffer = TestFile.loadHTML('./lib/domain/transfermarkt/SpielerlisteWithOffer.test.html')
    const htmlOnePlayerMissing = TestFile.loadHTML('./lib/domain/transfermarkt/SpielerlisteOnePlayerMissing.test.html')
