...
describe('TransfermarktService', () => {
    ...
    test('default', async () => {
        ...
        // Then
        expect(Object.keys(objectUnderTest.player()).length).toBe(0)
    ...
    test('init', async () => {
        ...
        // Then
        expect(Object.keys(objectUnderTest.player()).length).toBe(1)
    ...
    test('update', async () => {
        ...
        // Then
        expect(Object.keys(objectUnderTest.player()).length).toBe(436)
