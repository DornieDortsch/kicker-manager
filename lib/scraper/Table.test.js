...
describe('Table', () => {
    ...
    test('Table with Transfer History HTML Page that use split on seperator.', () => {
        // Given
        ...
        // When
        const phases = Table(html, 'spieler', 8, () => Object.create(null), true)

        // Then
        expect(phases.length).toBe(2)
        expect(phases[0].length).toBe(2)
        expect(phases[1].length).toBe(1)
